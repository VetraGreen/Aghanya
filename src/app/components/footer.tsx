export default function Footer() {
    return(
        <div className="py-10 bg-[#371212] px-20">
            ...
            <div className="flex justify-center flex-row text-3xl mt-14 gap-40">
                ...
                <div>
                    EMAIL: 
                    <div className="text-2xl pt-2 text-[#848484]">aghanya@vetragreentech.com</div>
                </div>
                <div>
                    WHATSAPP:
                    <div className="text-2xl pt-2 text-[#848484]">+91 91642 93953, +1 224 622 4581</div>
                </div>
            </div>
        </div>
    )
